...
class Frame:
    ...
    def show_result(self):
        ...
        cv2.putText(frame, 'Frame Processing Speed: ' + str(self.frame_rate_processing) + ' FPS', (self.frame_width - self.frame_width/2, self.frame_height - 20), cv2.FONT_HERSHEY_DUPLEX, 0.5, text_color, 1, cv2.LINE_AA)
